    ...
    def get_attributes(self):
        return [Input("input")], \
               ...
               [ComboboxParameter("operation", values=OrderedDict([
                ...
                IntParameter("element size", "Size of structuring element", 5,
                             min_=1, max_=255, step=2),
                IntParameter("iterations", "Number of iterations",
                             1, min_=0, max_=255)]
    ...
    def get_attributes(self):
        return [Input("input")], \
               ...
               [ComboboxParameter("element type", values=OrderedDict([
                        ...
                        ("MORPH_ELLIPSE", cv.MORPH_ELLIPSE),
                        ("MORPH_CROSS", cv.MORPH_CROSS)])),
                IntParameter("element size", "Size of structuring element",
                             5, min_=1, max_=255, step=2),
                IntParameter("iterations", "Number of iterations",
                             1, min_=0, max_=255)]
